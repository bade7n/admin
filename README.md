...
- admin-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- admin-ui: main application module, development time
- admin-production: module that produces a production mode WAR for deployment
